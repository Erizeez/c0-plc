package erizeez.tokenizer;

import erizeez.error.ErrorCode;
import erizeez.error.TokenizeError;
import erizeez.util.DoubleLiteral;
import erizeez.util.Pos;

import static erizeez.tokenizer.CharCheck.isEscapeChar;
